...
export function workflowDefinitionAdd(data: any) {
  return requestClient.postWithMsg('/workflow/definition', data);
}
...
export function workflowDefinitionUpdate(data: any) {
  return requestClient.putWithMsg('/workflow/definition', data);
}
...
export function workflowDefinitionDelete(ids: IDS) {
  return requestClient.deleteWithMsg(`/workflow/definition/${ids}`);
}
...
export function workflowDefinitionCopy(id: ID) {
  return requestClient.postWithMsg(`/workflow/definition/copy/${id}`);
}
